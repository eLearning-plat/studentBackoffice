    ...
    <div class="flex flex-col min-h-[100dvh] bg-background mt-2 w-full">
      <div class="flex justify-end">
        <input
          ...
          type="search"
          placeholder="Search"
          class="border-2 border-gray-400 rounded p-2 w-full mx-3 sm:w-1/3 md:w-1/3 text-gray-500 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400"
        />
        <button
